...
export const SUBJECTS: Record<SubjectCode, SubjectMeta> = {
  ...
  biology: {
    ...
    spec: "YBI / WBI",
    units: [
      { number: 1, unitCode: "U1", name: "Molecules, Diet, Transport and Health",
      ...
      { number: 2, unitCode: "U2", name: "Cells, Development, Biodiversity and Conservation",
  ...
  physics: {
    ...
    units: [
      ...
      { number: 4, unitCode: "U4", name: "Further Mechanics, Fields and Particles",
        ...
        topics: [
          "Momentum in Two Dimensions and Impulse",
          "Circular Motion",
          ...
          "Magnetic Flux Density and Force on a Current",
          "Force on a Moving Charged Particle",
          "Electromagnetic Induction and Faraday's Law",
          "The Nuclear Atom and Particle Accelerators",
      ...
      { number: 5, unitCode: "U5", name: "Thermodynamics, Radiation, Oscillations and Cosmology",
        ...
        topics: [
          ...
          "Binding Energy and Mass Defect (E = mc²)",
          "Nuclear Fission and Fusion",
          "Newton's Law of Gravitation",
          "Gravitational Field Strength (Radial Fields)",
